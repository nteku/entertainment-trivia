...
public class MusicActivity extends AppCompatActivity {
    ...
    public void initializeLists(){
        ...
        question1.add("What is the most popular music genre in the world?");
        question1.add("Pop");
        question1.add("Rock");
        question1.add("Hip Hop");
        question1.add("Pop");

        List<String> question2 = new ArrayList<>();
        question2.add("Which artist has the most Grammys?");
        question2.add("Michael Jackson");
        question2.add("Beyonce");
        question2.add("Stevie Wonder");
        question2.add( "Beyonce");

        List <String> question3 = new ArrayList<>();
        question3.add("How many number one albums does Michael Jackson have?");
        question3.add("11");
        question3.add("7");
        question3.add("13");
        question3.add("7");
