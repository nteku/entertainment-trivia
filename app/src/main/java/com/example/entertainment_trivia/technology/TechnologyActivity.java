package com.example.entertainment_trivia.technology;
...
/**
 * Class: TechnologyActivity.java
 * Purpose: Activity tests user's knowledge in Technology
 * @author Nathan Teku
 */
public class TechnologyActivity extends AppCompatActivity
{
        ...
        option1.setOnClickListener((v) ->
        {
            ...
            if (option1.getText().equals(answer))
            {
                ...
                switch ((int) questionsDone)
                {
                    ...
                    case 2:
                        option1.setText(R.string.plusSix);
                        score += SIX;
                        questionsCorrect++;
                        questionsDone++;
                        disableButtons();
    ...
    public void initializeData()
    {
        ...
        {
            // reading text file
            DataInputStream textFileStream = new DataInputStream(getAssets().open(String.format(getResources().getString(R.string.technology_File))));
